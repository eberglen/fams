  ...
  <div class="row">
    <div class="col-md-3">Date
      <select class="form-control" name="date" id="date">
        ...
        <option value="1">January 10</option>
        <option value="2">Janury 25</option>
        <option value="3">February 10</option>
        <option value="4">February 25</option>
        <option value="5">March 10</option>
        <option value="6">March 25</option>
        <option value="7">April 10</option>
        <option value="8">April</option>
        <option value="9">May 10</option>
        <option value="10">May 25</option>
        <option value="11">June 10</option>
        <option value="12">June 25</option>
        <option value="13">July 10</option>
        <option value="14">July 25</option>
        <option value="15">August 10</option>
        <option value="16">August 25</option>
        <option value="17">September 10</option>
        <option value="18">September 25</option>
        <option value="19">October 10</option>
        <option value="20">October 25</option>
        <option value="21">November 10</option>
        <option value="22">November 25</option>
        <option value="23">December 10</option>
        <option value="24">December 25</option>
      </select>
    </div>
